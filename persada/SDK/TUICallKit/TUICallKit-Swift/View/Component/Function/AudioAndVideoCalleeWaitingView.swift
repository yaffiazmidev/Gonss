...
class AudioAndVideoCalleeWaitingView: UIView {
    ...
    lazy var acceptBtn: BaseControlButton = {
        ...
        let acceptBtn = BaseControlButton.create(
            frame: CGRect.zero,
            title: "Jawab",
    ...
    lazy var rejectBtn: BaseControlButton = {
        weak var weakSelf = self
        let rejectBtn = BaseControlButton.create(
            frame: CGRect.zero,
            title: "Tolak",
            imageSize: CGSize(width: 56, height: 56)
        ) { sender in
    ...
    func constructViewHierarchy() {
        ...
        acceptBtn.titleLabel.font = .systemFont(ofSize: 12, weight: .medium)
        rejectBtn.titleLabel.font = .systemFont(ofSize: 12, weight: .medium)
    }
