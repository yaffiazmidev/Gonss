...
#import "TUIDefine.h"
// 点赞动画播放限制，最多播放10组
static NSInteger likeMaxAnimationCount = 1000;
...
- (void)playLikeModel:(TUIGiftModel *)likeModel {
    ...
    CGRect startFrame = CGRectMake((Screen_Width*5)/6, Screen_Height-Bottom_SafeHeight-10-44, 30, 30);
    ...
    heartImageView.image = [heartImage imageWithRenderingMode:UIImageRenderingModeAutomatic];
