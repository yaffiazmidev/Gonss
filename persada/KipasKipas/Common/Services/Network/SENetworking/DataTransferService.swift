...
extension DefaultDataTransferService: DataTransferService {
    ...
    public func request<T: Decodable, E: ResponseRequestable>(with endpoint: E,
        ...
        return networkService.request(endpoint: endpoint) { result in
            ...
            case .success(let data):
                let result: Swift.Result<T, DataTransferError> = self.decode(data: data, decoder: endpoint.responseDecoder)
    ...
    // MARK: - Private
    private func decode<T: Decodable>(data: Data?, decoder: ResponseDecoder) -> Swift.Result<T, DataTransferError> {
        do {
