//
//  DENCollectionViewLayout.swift
//  KipasKipas
//
//  Created by DENAZMI on 10/04/22.
...
@objc public protocol DENCollectionViewDelegateLayout: UICollectionViewDelegate {
...
@available(*, unavailable, renamed: "DENCollectionViewLayout.ItemRenderDirection")
public enum DENCollectionViewLayoutItemRenderDirection { }

public extension DENCollectionViewLayout.ItemRenderDirection {
    @available(*, unavailable, renamed: "shortestFirst")
    static let DENCollectionViewLayoutItemRenderDirectionShortestFirst = 0
    @available(*, unavailable, renamed: "leftToRight")
    static let DENCollectionViewLayoutItemRenderDirectionLeftToRight = 1
    @available(*, unavailable, renamed: "rightToLeft")
    static let DENCollectionViewLayoutItemRenderDirectionRightToLeft = 2
}

extension DENCollectionViewLayout {
...
public let DENCollectionElementKindSectionHeader = "DENCollectionElementKindSectionHeader"
@available(*, unavailable, renamed: "UICollectionView.elementKindSectionFooter")
public let DENCollectionElementKindSectionFooter = "DENCollectionElementKindSectionFooter"
public class DENCollectionViewLayout: UICollectionViewLayout {
    ...
    public var columnCounts: [Int]? = nil {
        didSet{
            invalidateLayout()
        }
    }
    ...
    public var minimumColumnSpacings: [CGFloat]? = nil {
        didSet {
            invalidateLayout()
        }
    }
    ...
    public var minimumInteritemSpacings: [CGFloat]? = nil {
        didSet {
            invalidateLayout()
        }
    }
    ...
    public var headerHeights: [CGFloat]? = nil {
        didSet {
            invalidateLayout()
        }
    }
    ...
    public var footerHeights: [CGFloat]? = nil {
        didSet {
            invalidateLayout()
        }
    }
    ...
    public var sectionInsets: [UIEdgeInsets]? = nil {
        didSet {
            invalidateLayout()
        }
    }
    ...
    public var delegate: DENCollectionViewDelegateLayout? {
        get {
            return collectionView!.delegate as? DENCollectionViewDelegateLayout
        }
    }
    ...
    private func columnCount(forSection section: Int) -> Int {
        return delegate?.collectionView?(collectionView!, layout: self, columnCountFor: section) ?? columnCounts?[section] ?? columnCount
    }
    ...
    private func collectionViewContentWidth(ofSection section: Int) -> CGFloat {
        let insets = delegate?.collectionView?(collectionView!, layout: self, insetsFor: section) ?? sectionInsets?[section] ?? sectionInset
    ...
    public func itemWidth(inSection section: Int) -> CGFloat {
        ...
        return floor((width - (spaceColumCount * (minimumColumnSpacings?[section] ?? minimumColumnSpacing))) / CGFloat(columnCount))
    }
    ...
    override public func prepare() {
        ...
        for section in 0 ..< numberOfSections {
            ...
            ?? self.minimumInteritemSpacings?[section] ?? self.minimumColumnSpacing
            let sectionInsets = delegate?.collectionView?(collectionView!, layout: self, insetsFor: section) ?? self.sectionInsets?[section] ?? self.sectionInset
            ...
            ?? self.headerHeights?[section] ?? self.headerHeight
            if heightHeader > 0 {
            ...
            for idx in 0 ..< itemCount {
                ...
                let xOffset = sectionInsets.left + (itemWidth + (minimumColumnSpacings?[section] ?? minimumColumnSpacing)) * CGFloat(columnIndex)
            ...
            let footerHeight = delegate?.collectionView?(collectionView!, layout: self, heightForFooterIn: section) ?? self.footerHeights?[section] ?? self.footerHeight
