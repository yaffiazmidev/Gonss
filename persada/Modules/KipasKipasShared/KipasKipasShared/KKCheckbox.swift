...
// Based on https://github.com/RiftValleySoftware/RVS_Checkbox/blob/main/Sources/RVS_Checkbox/RVS_Checkbox.swift

import UIKit

@IBDesignable
public class KKCheckbox: UISwitch {
    /* ###################################################################################################################################### */
     ...
     */
    public class KKCheckboxImage: UIImage {
        /* ################################################################################################################################## */
         ...
         */
        public var myFillColor: UIColor = .label
         ...
         */
        public override func draw(in inRect: CGRect) {
         ...
         */
        public override func draw(at inPoint: CGPoint) {
         ...
         */
        public override func withTintColor(_ inTintColor: UIColor) -> UIImage {
         ...
         */
        public var asImage: UIImage! { preconditionFailure("This Computed Property Must be Overridden by Subclasses!" ) }
    }
     ...
     */
    public class KKCheckboxImageClear: KKCheckboxImage {
        /* ################################################################## */
        /**
         This supplies a rendered image. It will use the myFillColor.
         */
        public override var asImage: UIImage! {
     ...
     */
    public class KKCheckboxImageOn: KKCheckboxImage {
        /* ################################################################## */
        /**
         This supplies a rendered image. It will use the myFillColor.
         */
     ...
     */
    class KKCheckboxImageOff: KKCheckboxImage {
        /* ################################################################## */
        /**
         This supplies a rendered image. It will use the myFillColor.
         */
    ...
    private func _image(forState inState: States) -> UIImage? {
        ...
        onImage = onImage ?? (isUsingSFSymbols ? UIImage(systemName: Self._sSFOn, withConfiguration: Self._sSFConfig) ?? KKCheckboxImageOn() : KKCheckboxImageOn())
        clearImage = clearImage ?? (isUsingSFSymbols ? UIImage(systemName: sfClearImageName, withConfiguration: Self._sSFConfig) ?? KKCheckboxImageClear() : KKCheckboxImageClear())
        offImage = offImage ?? (isUsingSFSymbols ? UIImage(systemName: Self._sSFOff, withConfiguration: Self._sSFConfig) ?? KKCheckboxImageOff() : KKCheckboxImageOff())
