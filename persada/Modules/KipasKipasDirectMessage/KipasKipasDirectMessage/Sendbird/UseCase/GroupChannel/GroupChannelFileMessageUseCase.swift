...
open class GroupChannelFileMessageUseCase {
    ...
    open func sendFileMessage(_ mediaFile: MediaFile, completion: @escaping (Result<FileMessage?, SBError>) -> Void) {
        let fileMessageParams = FileMessageCreateParams(file: mediaFile.data)
        ...
        completion(.success(fileMessage))
    }
    
    open func sendFileMessage(data: String?, _ mediaFile: MediaFile, completion: @escaping (Result<FileMessage?, SBError>) -> Void) {
        let fileMessageParams = FileMessageCreateParams(file: mediaFile.data)
