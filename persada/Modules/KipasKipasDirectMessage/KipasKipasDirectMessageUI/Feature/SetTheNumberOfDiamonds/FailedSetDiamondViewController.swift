...
final class FailedSetDiamondViewController: UIViewController {
	...
	private lazy var titleLbl: UILabel = {
		...
		label.text = "Belum berhasil menerapkan perubahan!"
		return label
	}()
	...
	lazy var subtitleLbl: UILabel = {
		...
		label.text = "Sepertinya ada kendala pada proses perubahan jumlah diamond, coba kembali dan pastikan koneksimu stabil untuk melakukan perubahan ini."
		return label
	}()
	...
	lazy var iconDiamond: UIImageView = {
		...
		image.image = UIImage.set("ic_alarm_sign")
