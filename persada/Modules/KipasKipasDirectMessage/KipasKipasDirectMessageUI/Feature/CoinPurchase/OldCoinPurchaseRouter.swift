...
protocol OldICoinPurchaseRouter {
...
public class OldCoinPurchaseRouter: OldICoinPurchaseRouter {
    weak var controller: OldCoinPurchaseViewController?
    let baseUrl: String
    let authToken: String
    
    init(controller: OldCoinPurchaseViewController?, baseUrl: String, authToken: String) {
...
extension OldCoinPurchaseRouter {
    public static func create(baseUrl: String, authToken: String) -> OldCoinPurchaseViewController {
        let controller = OldCoinPurchaseViewController()
        let router = OldCoinPurchaseRouter(controller: controller, baseUrl: baseUrl, authToken: authToken)
        let presenter = OldCoinPurchasePresenter(controller: controller)
        ...
        let interactor = OldCoinPurchaseInteractor(presenter: presenter, network: network, inAppLoader: MainQueueDispatchDecorator(decoratee: inAppLoader), inAppPurchaser: inAppPurchaser, coinInAppValidator: coinInAppValidator)
