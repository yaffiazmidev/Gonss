...
protocol OldICoinPurchasePresenter {
...
class OldCoinPurchasePresenter: OldICoinPurchasePresenter {
    
    weak var controller: OldICoinPurchaseViewController?
    
    init(controller: OldICoinPurchaseViewController) {
