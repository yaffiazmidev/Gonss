...
@IBDesignable open class ActiveLabel: UILabel {
	...
	@available(*, renamed: "mention.Color")
	@IBInspectable open var mentionColor: UIColor = .systemBlue {
        didSet { updateTextStorage(parseText: false) }
    }
	
	@available(*, renamed: "mention.Selected.Color")
	@IBInspectable open var mentionSelectedColor: UIColor? {
        didSet { updateTextStorage(parseText: false) }
    }
	
	@available(*, renamed: "hashtag.Color")
	@IBInspectable open var hashtagColor: UIColor = .systemBlue {
        didSet { updateTextStorage(parseText: false) }
    }
	
	@available(*, renamed: "hashtag.Selected.Color")
	@IBInspectable open var hashtagSelectedColor: UIColor? {
        didSet { updateTextStorage(parseText: false) }
    }
	
	@available(*, renamed: "URLColor")
	@IBInspectable open var URLColor: UIColor = .blue {
        didSet { updateTextStorage(parseText: false) }
    }
	
	@available(*, renamed: "URLSelectedColor")
	...
	@available(*, renamed: "lineSpacing")
	@IBInspectable public var lineSpacing: CGFloat = 0 {
        didSet { updateTextStorage(parseText: false) }
    }
	@available(*, renamed: "minimumLineHeight")
	@IBInspectable public var minimumLineHeight: CGFloat = 0 {
        didSet { updateTextStorage(parseText: false) }
    }
	
	@available(*, renamed: "highlightFontName")
