...
class VersaVideoPlayer: VideoPlayer {
    // MARK: Variable of VideoPlayer Protocol
    
    static var instance: VideoPlayer = VersaVideoPlayer()
...
// MARK: - Versa Delegate
extension VersaVideoPlayer : VersaPlayerPlaybackDelegate {
...
fileprivate extension VersaVideoPlayer {
    ...
    @objc func willResignActive(_ notification: Notification) {
        ...
        print("*** VersaVideoPlayer enter background ", isPaused)
    }
    ...
    @objc func willEnterForeground(_ notification: Notification) {
        ...
        print("*** VersaVideoPlayer enter foreground ", isPaused)
    }
}
