//
//  TencentVideoPlayerHelper.swift
//  KKPlayerApp
//
...
class TencentVideoPlayerHelper {
    static let instance: TencentVideoPlayerHelper = TencentVideoPlayerHelper()
    
    private let TENCENT_APP_ID = 1316940742
    
    let LOG_ID = "====TencentVideoPlayerHelper"
