...
final class StoryListRepostCellController: NSObject {
    
    private var cell: BaseStoryRepostCell?
...
extension StoryListRepostCellController: UICollectionViewDataSource {
    ...
    private func createCell(
        ...
        switch perspective {
        case .me:
            let cell: StoryMeRepostCell = collectionView.dequeueReusableCell(at: indexPath)
            self.cell = cell
            
        case .friends:
            let cell: StoryFriendsRepostCell = collectionView.dequeueReusableCell(at: indexPath)
            self.cell = cell
        }
...
extension StoryListRepostCellController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didEndDisplaying cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        let cell = cell as? BaseStoryRepostCell
        cell?.cleanUp()
...
extension StoryListRepostCellController: SegmentedProgressViewDataSource, SegmentedProgressViewDelegate {
    var numberOfSegments: Int {
        return stories.count
    }
    
    var segmentDuration: TimeInterval? {
        return cell?.repostView.playDuration
    }
