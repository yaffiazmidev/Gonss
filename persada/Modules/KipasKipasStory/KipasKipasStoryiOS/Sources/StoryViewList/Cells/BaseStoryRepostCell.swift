...
internal class BaseStoryRepostCell: UICollectionViewCell, StoryCell {
    ...
    let repostView = StoryRepostView()
    ...
    func pause() {
        repostView.playView.pause()
    }
    
    func resume() {
        repostView.playView.resume()
    }
    ...
    func configure(with story: StoryItemViewModel, index: Int) {
        ...
        currentIndex = index
        repostView.playView.delegate = self
        repostView.configure(with: story)
...
extension BaseStoryRepostCell: StoryPlayViewDelegate {
...
extension BaseStoryRepostCell: SegmentedProgressViewDelegate {
...
// MARK: UI
private extension BaseStoryRepostCell {
    func configureUI() {
    ...
    func configurePreviewView() {
        ...
        repostView.layer.cornerRadius = 16
        repostView.clipsToBounds = true
            
        stackContainer.addArrangedSubview(repostView)
    }
    ...
    func configureStackTopView() {
        ...
        repostView.addSubview(stackTopView)
    ...
    func configurePreviousButton() {
        ...
        repostView.addSubview(previousButton)
    ...
    func configureNextButton() {
        ...
        repostView.addSubview(nextButton)
