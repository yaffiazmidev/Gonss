...
public final class DonationStatisticsContainerViewController: UIViewController {
...
// MARK: UI
private extension DonationStatisticsContainerViewController {
    func configureUI() {
        configurePageMenu()
        configureBackButton()
...
extension DonationStatisticsContainerViewController: KKPageViewControllerEventDelegate {
