...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func configureRootViewController(in window: UIWindow) {
        ...
        if tokenStore.retrieve() == nil {
            ...
            window.rootViewController = makeDonationGlobalRankViewController()
        }
    }
...
private extension SceneDelegate {
    ...
    func makeLoginViewController() -> UIViewController {
        ...
        let loaders = LoginUIComposer.Loader(loginLoader: makeLoginLoader)
        ...
        featureLabel.text = "KipasKipasDonationRank"
