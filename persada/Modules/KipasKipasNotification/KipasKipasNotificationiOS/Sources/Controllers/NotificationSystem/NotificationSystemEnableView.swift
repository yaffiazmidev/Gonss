...
protocol NotificationSystemEnableViewDelegate {
    func didTapClose()
    func didSwitch(for item: TransactionViewSwitch, isOn: Bool)
}

class NotificationSystemEnableView: UIView {
    
    var delegate: NotificationSystemEnableViewDelegate?
...
extension NotificationSystemEnableView {
...
// MARK: - Private Helper
private extension NotificationSystemEnableView {
    func configUI() {
