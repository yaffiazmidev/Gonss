...
final class NotificationSystemViewService {
    private weak var controller: NotificationSystemController?
    private let service: NotificationSystemService
    private let selection: (String) -> Void
    
    init(controller: NotificationSystemController?, service: NotificationSystemService, selection: @escaping (String) -> Void) {
...
extension NotificationSystemViewService: NotificationSystemView {
...
extension NotificationSystemViewService: NotificationSystemIsReadView, NotificationSystemIsReadErrorLoadingView {
