...
protocol PostPreviewMediaViewDelegate where Self: UIViewController {
...
final class PostPreviewMediaView: UIView {
	
	weak var delegate: PostPreviewMediaViewDelegate?
	...
	override func draw(_ rect: CGRect) {
		...
		collectionView.anchor(top: safeAreaLayoutGuide.topAnchor, left: leftAnchor, bottom: pageControl.topAnchor, right: rightAnchor, paddingTop: 16, paddingLeft: 16, paddingBottom: 16, paddingRight: 16, width: UIScreen.main.bounds.width)
	}
...
extension PostPreviewMediaView: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.bindData(medias: medias[indexPath.row])
	...
	func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        if let cell = collectionView.cellForItem(at: indexPath) as? MediaItemCell {
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        let cell = cell as! MediaItemCell
        cell.video?.pause()
    }
