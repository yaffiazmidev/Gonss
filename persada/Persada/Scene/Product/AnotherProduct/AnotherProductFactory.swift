...
class AnotherProductFactory{
    static func createAnotherProductController(account: Profile) -> AnotherProductController {
        ...
        let controller = AnotherProductController(mainView: AnotherProductView())
