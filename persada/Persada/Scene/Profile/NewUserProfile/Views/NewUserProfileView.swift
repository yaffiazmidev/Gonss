...
protocol NewUserProfileViewDelegate where Self: UIViewController {
	
	func refresh()
}

final class NewUserProfileView: UIView {
	...
	override init(frame: CGRect) {
		...
		collectionView.anchor(top: topAnchor, left: leftAnchor, bottom: safeAreaLayoutGuide.bottomAnchor, right: rightAnchor, paddingTop: ViewTrait.padding, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
