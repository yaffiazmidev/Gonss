...
protocol FollowersViewDelegate where Self: UIViewController {
...
final class FollowersView: UIView {
	...
	lazy var tableView: UITableView = {
		...
		table.registerCustomCell(FollowersItemCell.self)
		return table
	}()
	...
	lazy var labelEmptyPlaceholder: UILabel = UILabel(text: .get(.dontHaveAFollowers), font: UIFont.Roboto(.bold, size: 14), textColor: .placeholder, textAlignment: .center, numberOfLines: 0)
