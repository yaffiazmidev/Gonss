...
class FollowingsItemCell: UITableViewCell {
    ...
    var data: Follower? {
        didSet {
            ...
            followButton.isHidden = data.id == getIdUser()
    ...
    private func configureStack() {
        ...
        stackView.anchors.trailing.equal(followButton.anchors.leading, constant: -12)
    ...
    private func configureFollowButton() {
        ...
        followButton.anchors.height.equal(30)
        followButton.anchors.centerY.equal(contentView.anchors.centerY)
        followButton.anchors.trailing.equal(contentView.safeAreaLayoutGuide.anchors.trailing)
    }
    ...
    func configureStatus(_ status: Bool) {
        ...
        if status == true {
            ...
            followButton.setTitle("Ikuti", for: .normal)
        }
    }
}
