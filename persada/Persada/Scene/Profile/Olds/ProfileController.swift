...
class ProfileController: UIViewController, UIGestureRecognizerDelegate {
    ...
    let headerProfileUser: ProfileUserHeaderView = {
        let viewUser = ProfileUserHeaderView()
    ...
    override func viewDidLoad() {
        ...
        headerProfileUser.anchor(top: view.safeAreaLayoutGuide.topAnchor, leading: view.leadingAnchor, bottom: nil, trailing: view.trailingAnchor, padding: UIEdgeInsets(), size: CGSize(width: 0, height: heightHeader))
    ...
    func configureUserUI() {
        headerProfileUser.buttonFollow.isHidden = true
        headerProfileUser.buttonFollow.isHidden = true
        self.heightHeader = 180
    }
...
extension ProfileController: UIPageViewControllerDelegate, UIPageViewControllerDataSource {
...
extension ProfileController: ContextMenuDelegate {
