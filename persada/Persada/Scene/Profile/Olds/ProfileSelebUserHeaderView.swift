//
//  ProfileSelebUserHeaderView.swift
//  Persada
//
...
class ProfileSelebUserHeaderView: UIView {
    ...
    lazy var buttonShop: BadgedButton = {
        ...
        button.setTitle("My Shop", for: .normal)
        button.setImage(UIImage(named: "iconLocalMall"), for: .normal)
    ...
    let viewSpace: UIView = {
        let vwSpace = UIView()
        vwSpace.translatesAutoresizingMaskIntoConstraints = false
        return vwSpace
    }()
    ...
    override func draw(_ rect: CGRect) {
        ...
        let stackViewFollow = UIStackView(arrangedSubviews: [buttonShop, buttonFollow, viewSpace])
        stackViewFollow.distribution = .fillProportionally
        stackViewFollow.axis = .horizontal
        stackViewFollow.spacing = 10
        ...
        viewFrame.addSubview(buttonShop)
        ...
        buttonShop.anchor(top: stackViewStatus.bottomAnchor, left: viewFrame.leftAnchor, bottom: nil, right: nil, paddingTop: 8, paddingLeft: 20, paddingBottom: 0, paddingRight: 20, width: 150, height: 40)

        buttonFollow.anchor(top: stackViewStatus.bottomAnchor, left: buttonShop.rightAnchor, bottom: nil, right: nil, paddingTop: 8, paddingLeft: 20, paddingBottom: 0, paddingRight: 20, width: 130, height: 40)
    }
