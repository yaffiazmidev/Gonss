...
final class NewsTableCell: UITableViewCell {
	...
	let postTextLabel: UILabel = {
		let lbl = UILabel(text: "", font: .Roboto(.medium, size: 18), textColor: .black, textAlignment: .left, numberOfLines: 3)
	...
	let nameLabel = UILabel(text: "0", font: .Roboto(.regular, size: 12), textColor: .black, textAlignment: .left, numberOfLines: 1)
...
//		contentView.addSubview(buttonsView)
		...
		imageViewGrid.anchor(top: contentView.topAnchor, right: contentView.rightAnchor, paddingRight: 20, width: 90, height: 90)
		
		addSubview(dateLabel)
		dateLabel.anchor(top: nil, left: leftAnchor, bottom: imageViewGrid.bottomAnchor, right: rightAnchor, paddingTop: 6, paddingLeft: 20, paddingBottom: 0)
