...
final class NewsTableCellBigger: UITableViewCell {
	...
	let postTextLabel: UILabel = {
		let lbl = UILabel(text: "", font: .Roboto(.medium, size: 18), textColor: .black, textAlignment: .left, numberOfLines: 2)
	...
	lazy var buttonShare = UIButton(image: #imageLiteral(resourceName: "iconSharealt"))
...
//		contentView.addSubview(buttonsView)
		...
		postTextLabel.anchor(top: topAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 20, paddingLeft: 20, paddingRight: 20)
		dateLabel.anchor(top: postTextLabel.bottomAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 8, paddingLeft: 20)
		imageViewGrid.anchor(top: dateLabel.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 8, paddingLeft: 20, paddingBottom: 8, paddingRight: 20, height: 230)
