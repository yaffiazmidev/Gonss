//
//  NewsBiggerTopTitleViewCell.swift
//  KipasKipas
//
...
class NewsBiggerTopTitleViewCell: UITableViewCell {
    ...
    func setUpCell(item: NewsCellViewModel) {
        imageNews.loadImage(at: item.imageNewsUrl ?? "", low: item.imageNewsUrl ?? "", .w576, .w360)
