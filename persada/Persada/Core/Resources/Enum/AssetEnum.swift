...
enum AssetEnum : String {
	...
	*/
    ...
    case iconLinkGrey
    case iconLinkWhite
    case imageContentEmpty
    
    case iconCameraButton
    case iconLibraryButton
    case iconBadgeButton
    case iconMove
    case iconCloseCircle
    case iconLinkPlaceholder
    case iconCheckCircleGrey
    case iconSettingGrey
    case iconAddCircleGreenBorderWhite
    case iconRemoveCircleRedBorderWhite
    
    case iconDonationCartWhite
    case iconDonationCartPink
    case iconDonationCartAddPink
    case iconTrashFillGrey
}
