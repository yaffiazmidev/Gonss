...
@available(iOS 9.0, *)
open class CustomFormController: UIViewController {
    ...
    public required init?(coder aDecoder: NSCoder) {
        fatalError("You most likely have a Storyboard controller that uses this class, please remove any instance of CustomFormController or sublasses of this component from your Storyboard files.")
    }
